...
Quaternius — Zombie Apocalypse Kit (March 2024).
...
Original textured, rigged glTF assets with embedded resources. Display scale,
orientation and animation mappings are configured by DROPZONE at runtime.
These are not assets from Clash Royale.
